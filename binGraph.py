...
if __name__ == '__main__':
    ...
    parser_bin_ent.add_argument('-c','--chunks', type=int, default=__chunks__, metavar='72', help='Defines how many chunks the binary is split into (and therefore the amount of bytes submitted for shannon sampling per time). Higher number gives more detail')
